{{-- resources/views/admaddresses/modal-create.blade.php --}}
<div class="modal fade" id="createAdmaddressModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">
                    <i class="bi bi-plus-circle me-2"></i>Tambah Data ADM Address
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <form id="createAdmaddressForm" method="POST" action="{{ route('admaddresses.store') }}">
                @csrf
