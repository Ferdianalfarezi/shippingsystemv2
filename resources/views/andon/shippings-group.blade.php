...
@section('title', 'Andon - Shipping Group Monitoring')
...
@section('content')
    ...
    <div class="d-flex justify-content-end align-items-center gap-2 mb-3 mt-3">
        ...
        <div class="card border-0 shadow-sm bg-warning p-0 pt-1 pb-1">
            <a href="{{ route('andon.shippings') }}" class="btn btn-warning" title="Switch to Reverse View">
        ...
        <!-- Delay Badge with Blinking Effect -->
        <div class="bg-danger card border-0 shadow-sm blink-delay" id="badgeDelayBox">
            <div class="card-body p-1">
                <div class="d-flex align-items-center">
                    <div class="bg-white bg-opacity-10 p-2 rounded me-2">
    ...
    <div class="table-responsive p-0 mt-0">
        <table class="table table-compact w-100 mt-1" id="shippingsGroupTable">
            <thead>
                <tr class="fs-5">
                    <th>Route</th>
                    <th>LP</th>
...
$(document).ready(function () {
    ...
    setInterval(() => {
        ...
        if (!document.hidden) {
            ...
            $("#shippingsGroupTable").load(location.href + " #shippingsGroupTable>*");
